      ...
      <div className="hero-right">
        <div className="hero-image-placeholder">
          ...
          <svg style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', opacity: 0.2 }} width="280" height="200" viewBox="0 0 280 200" fill="none">
            <rect x="20" y="60" width="240" height="130" rx="4" stroke="#3a7d44" strokeWidth="2" />
            <circle cx="140" cy="130" r="45" stroke="#3a7d44" strokeWidth="2" />
            <circle cx="140" cy="130" r="30" stroke="#3a7d44" strokeWidth="1" opacity="0.5" />
            <circle cx="140" cy="130" r="12" fill="#3a7d44" opacity="0.3" />
            <rect x="80" y="40" width="60" height="22" rx="2" stroke="#3a7d44" strokeWidth="2" />
            <rect x="220" y="75" width="25" height="16" rx="2" stroke="#3a7d44" strokeWidth="1.5" />
            <circle cx="40" cy="80" r="8" stroke="#3a7d44" strokeWidth="1.5" />
          </svg>
          <div className="hero-checker-overlay chess-bw">
